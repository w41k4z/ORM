 ...
 * <li>datasource.file: The configuration file of the DataSource
 * implementation</li>
 * </ul>
 * 
 */
public final class OrmConfiguration {
     ...
     * @throws Exception If the DataSource cannot be loaded
     */
    public static DataSource getDataSource() throws Exception {
        ConfigurationFile configFile = new PropertiesFile();
        try {
            ...
            throw new Exception("The configuration file " + CONFIG_FILE_NAME
